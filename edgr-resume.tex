...
\section{Experience}
  ...
  %    \resumeItem{Introduced and onboarded SonarQube to aid in identifying and addressing code smells and potential bugs, improving code maintainability}
...
\section{Technical Skills and Interests}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      ...
      {Developer Tools}{: \textbf{Git/GitHub/GitLab}, \textbf{AWS}, \textbf{Azure}, \textbf{Webpack}, \textbf{MongoDB}, Supabase, Vercel, Figma} \\
