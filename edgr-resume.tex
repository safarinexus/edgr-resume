...
\section{Experience}
  ...
  %-------------------------------------------
    ...
    \resumeItemListStart
      \resumeItem{Build features on the frontend and backend for CIX's main platform, a global carbon credit solutions provider jointly held by Mizuho, Standard Chartered, DBS, SGX and Temasek}
      ...
      \resumeItem{Designed, developed, and maintained revenue-generating features for the CIX platform, utilizing React, Java and Azure}
