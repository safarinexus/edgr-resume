...
\begin{center}
    \small 
    \href{https://edgr.vercel.app}{\underline{edgr.vercel.app}} $|$ 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Singapore Management University}{Aug. 2020 -- Jun. 2025}
...
\section{Experience}
  ...
  %-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed unit-tested front-end components and APIs for 13 different customer products using React generating revenue of more than \$12k}
