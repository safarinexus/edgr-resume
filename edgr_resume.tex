...
\section{Incoming}
  \resumeSubHeadingListStart
    \resumeSubheading
    {Central Provident Fund Board}{Jan. 2025 -- Jun. 2025}
    {Incoming Software Engineer Intern}{Singapore}
    \resumeItemListStart
        \resumeItem{Joining the Frontier Products Team, Business Incubator \& Accelerator}
        \resumeItem{Technologies: \textbf{Next.js, Python}}
      \resumeItemListEnd
