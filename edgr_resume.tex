...
\section{Experience}
  ...
  %-------------------------------------------
    ...
    \resumeItemListStart
      ...
      \resumeItem{Work on enhancing platform stability by identifying, troubleshooting, and resolving critical bugs and infrastructure issues with both Java Spring Boot on the backend \& React Vite on the frontend.}
      \resumeItem{Collaborate with cross-functional teams to implement scalable solutions, ensuring long-term platform reliability and performance.}
