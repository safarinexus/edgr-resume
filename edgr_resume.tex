...
\section{Experience}
  ...
  %-------------------------------------------
    \resumeSubheading
    {Climate Impact X}{Feb. 2024 -- Present}
    {Software Engineer}{Singapore}
    \resumeItemListStart
      \resumeItem{A joint venture by DBS, SGX, Standered Chartered \& Temasek, I worked on CIX's main platform, a global exchange for carbon credits, where I developed Java microservices for part of their global marketplace}
      \resumeItem{Wrote JUnit test for codebase, increasing code coverage to 65\%, debugged and resolved critical issues on the platform}
      \resumeItem{Technologies: \textbf{Java, Spring Boot, JUnit, PostgreSQL}}
    \resumeItemListEnd

    \resumeSubheading
    {Central Provident Fund Board (CPFB)}{Jan. 2024 -- Feb. 2024}
    ...
    \resumeItemListStart
      ...
      \resumeItem{Adopted Jest unit testing for codebase, garnering 80\% code coverage, debugged and resolved critical product issues, refactored code to improve maintainability, improving product stability and reliability by 100\%}
