...
\section{Experience}
  ...
  %-------------------------------------------
    ...
    \resumeItemListStart
      \resumeItem{Worked as part of the Business Incubator \& Accelerator team on \textbf{docCentral}, a tool that automates filling in of extensive government documents and contracts from inputs from various sources, for use across the whole of government}
      ...
      \resumeItem{Enhanced team productivity by developing automation tools, such as a serverless API to automate task creation to Notion and Telegram via FormSG webhooks and a health monitoring express webhook that tracks product microservice health, compiles reports, and integrates with Telegram and MongoDB.}
      \resumeItem{Technologies: \textbf{Next.js, Node/Express, Python/Django, AWS, MongoDB, Jest}}
    \resumeItemListEnd
